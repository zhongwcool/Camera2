...
import com.alex.camera.cases.util.RectView;
...
public class Sample_Panorama extends Activity {
    ...
    /**
     * A {@link com.alex.camera.cases.util.RectView} for panorama tracing rect.
     */
    ...
    private void createUI() {
        ...
        mPanoramaPreview = findViewById(R.id.panorama_preview);
        mPanoramaRectView = findViewById(R.id.panorama_rect);
    }
    ...
    private void openCamera() {
        try {
            ...
            for (Size option : streamConfigurationMap.getOutputSizes(ImageFormat.YUV_420_888)) {
                ...
                if (!contains(mProcessor.getParameters().get(SCameraPanoramaProcessor.STREAM_SIZE_LIST), option))
                    continue;

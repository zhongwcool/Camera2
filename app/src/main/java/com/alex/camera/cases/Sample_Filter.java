...
public class Sample_Filter extends Activity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mSelectedFilterTextView = findViewById(R.id.selected_textview);

        findViewById(R.id.btn_select_image).setOnClickListener(this);
        findViewById(R.id.btn_select_filter).setOnClickListener(this);

        mBitmapButton = findViewById(R.id.btn_bitmap);
        mFileButton = findViewById(R.id.btn_file);
        ...
        mInputImageView = findViewById(R.id.input_image_view);
        mOutputImageView = findViewById(R.id.output_image_view);
